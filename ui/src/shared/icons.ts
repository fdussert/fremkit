/**
 * Inline subset of the Lucide icon set (https://lucide.dev) — ISC licence,
 * (c) Lucide Contributors. Each entry is the inner markup of a 24x24 stroked SVG.
 * Copied here on purpose: the UI must not take a runtime icon dependency.
 */
export const ICONS: Record<string, string> = {
  ...
  'memory-stick': '<path d="M6 19v-3"/><path d="M10 19v-3"/><path d="M14 19v-3"/><path d="M18 19v-3"/><path d="M8 11V9"/><path d="M12 11V9"/><path d="M16 11V9"/><path d="M2 15h20"/><path d="M4 5h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2Z"/>',
  ...
  pencil: '<path d="M21.2 6.8a2.7 2.7 0 0 0-3.8-3.8L4.3 16.1a2 2 0 0 0-.5.8l-1.3 4.3a.5.5 0 0 0 .6.7l4.4-1.3a2 2 0 0 0 .8-.5Z"/><path d="m15 5 4 4"/>',
